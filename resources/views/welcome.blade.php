        ...
        <div class="container">
            <section id="tentang">
                <div class="row featurette mt-5 mb-5">
                    ...
                    <div class="col-md-5">
                        <img src="{{  asset('gallery/2024/PH_Kadiv.jpg') }}"
                            class="bd-placeholder-img bd-placeholder-img-lg featurette-image rounded img-fluid mx-auto img-reveal"
            ...
            <section id="galeri">
                ...
                <ul class="rem-masonry judul" style="max-width: 100%!important;">
                        <li><img src="{{ asset('gallery/2024/1.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/5.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/2.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/4.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/3.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/7.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/10.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/8.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/6.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/9.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                        <li><img src="{{ asset('gallery/2024/11.jpg') }}" alt="masonry" style="border-radius: 10px;"></li>
                </ul>
            ...
            <div class="card mb-3 bg-green-1" >
                ...
                <div class="gabung">
                    <p class="text-center mt-3 fw-bold judul">
                        Mau bergabung jadi partner ASSETS? Yuk Lihat cara selengkapnya
                    </p>
                </div>
