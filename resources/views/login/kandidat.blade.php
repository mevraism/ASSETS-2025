                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('kandidat.delete', $kdt->no_urut) }}" method="POST">
                            @csrf
                            <button class="btn btn-danger" onclick="return confirm('hapus kandidat? ')"
                                type="submit">Hapus</button>
                        </form>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#exampleModal{{ $kdt->no_urut }}">
                            Update
                        </button>
                    </td>
                </tr>

                <div class="modal fade" id="exampleModal{{ $kdt->no_urut }}" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <form action="{{ route('kandidat.update', $kdt->no_urut) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama{{ $kdt->no_urut }}"
                                            value="{{ $kdt->nama }}" aria-describedby="emailHelp" name="nama"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1{{ $kdt->no_urut }}"
                                            class="form-label">NIM</label>
                                        <input type="text" class="form-control"
                                            id="exampleInputPassword1{{ $kdt->no_urut }}" value="{{ $kdt->nim }}"
                                            name="nim" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">isi dengan menggunakan separator "," (koma). Ex: " Pintar,
                                            Baik hati, Rajin Menabung" tanpa tanda kutip.</div>
                ...
                <div class="modal-body">
                    <form action="{{ route('kandidat.tambah') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nomor" aria-describedby="emailHelp"
                                name="nomor" maxlength="2" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">isi dengan menggunakan separator "," (koma). Ex: " Pintar, Baik hati,
                                Rajin Menabung" tanpa tanda kutip.</div>
