            ...
            <div class="container">
                <section id="galeri">
                    <div class="row featurette mb-5">
                        ...
                        <p class="lead fst-italic text-center konten">Yuk, gunakan hak pilih anda untuk ASSETS yang
                            lebih baik</p>
                                ...
                                @foreach ($kandidat_tabel as $kdt)
                                    <div class="col mb-3 judul mx-auto">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="token fst-italic text-center">Kandidat {{ $kdt->no_urut }} - Calon
                                                Ketua ASSETS 2022 </p>
                                            <p class="token fst-italic text-center">TRPL {{ $kdt->angkatan }}</p>
                                            <div class="d-flex justify-content-center mt-3">
                                                <form action="{{ route('token.submit', Session::get('token')) }}"
                                                    method="POST">
                                                    @csrf
                                                    <input type="hidden" name="no" value="{{ $kdt->no_urut }}">
                                                    <button class="btn btn-success button1" type="submit"
                                                        onclick="return confirm('yakin memilih?')">VOTE</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row featurette">
                                            <div class="col-md-4">
                                                <div class="d-flex justify-content-center">
                                                    <img src="{{ getAssetDir('thumb/' . $kdt->foto) }}" alt=""
                                                        srcset="" class="foto_kandidat" width="80%"
                                                        height="300px">
                                                </div>
                                                <div class="card-body">
                                                    <h2 class="text-center">{{ $kdt->nama }}</h2>
                                                    <p class="token fst-italic text-center">Kandidat
                                                        {{ $kdt->no_urut }}<br> Calon Ketua
                                                        ASSETS 2022 </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div>
                                                    <div class="container-fluid">
                                                        <div class="text-center">
                                                            <button type="button"
                                                                class="btn btn-abu mb-3">Visi</button>
                                                        </div>
                                                        <p>{{ $kdt->visi }}</p>
                                                    </div>
                                                </div>
