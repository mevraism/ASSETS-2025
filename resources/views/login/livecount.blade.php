        ...
        <div class="container">
            <section id="galeri">
                <div class="row featurette mb-3">
                    ...
                    <p class="lead fst-italic text-center konten">Yuk, gunakan hak pilih anda untuk ASSETS yang lebih
                        baik</p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-success button1" type="button"
                                                ...
                                                data-bs-target="#myModal1{{ $kdt->no_urut }}">Details</button>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row featurette">
                                        <div class="col-md-4">
                                            <div class="d-flex justify-content-center">
                                                <img src="{{ asset('thumb/' . $kdt->foto) }}" alt=""
                                                    srcset="" class="foto_kandidat" width="80%" height="300px">
                                            </div>
                                            <div class="card-body">
                                                <h2 class="text-center">{{ $kdt->nama }}</h2>
                                                <p class="token fst-italic text-center">Kandidat {{ $kdt->no_urut }}<br>
                                                    Calon Ketua
